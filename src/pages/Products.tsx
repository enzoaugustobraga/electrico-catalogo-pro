...
const Products = () => {
  const productCategories = [
    ...
    },
    {
      ...
      products: [
        "FIO ESMALTADO 0,15MM",
        "FIO ESMALTADO 0,20MM",
        "FIO ESMALTADO 0,25MM",
        "FIO ESMALTADO 0,30MM",
        "FIO ESMALTADO 0,35MM",
        "FIO ESMALTADO 0,40MM",
        "FIO ESMALTADO 0,45MM",
        "FIO ESMALTADO 0,50MM",
        "FIO ESMALTADO 0,55MM",
        "FIO ESMALTADO 0,60MM",
        "FIO ESMALTADO 0,70MM",
        "FIO ESMALTADO 0,80MM",
        "FIO ESMALTADO 0,90MM",
        "FIO ESMALTADO 1,00MM",
        "FIO ESMALTADO 1,20MM",
        "FIO ESMALTADO 1,50MM",
        "FIO ESMALTADO 1,80MM",
        "FIO ESMALTADO 2,00MM",
        "FIO ESMALTADO 2,50MM",
        "FIO ESMALTADO 3,00MM",
      ]
    },
    {
